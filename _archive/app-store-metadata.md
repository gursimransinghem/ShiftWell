...
## Keywords
shift work,sleep schedule,night shift,circadian rhythm,sleep optimization,nurse sleep,doctor sleep

## Description

Finally, a sleep app that understands your shift schedule.
...
- Schedule Import: Upload ICS calendar files from your work scheduling system. No manual entry required.
- Personalized Sleep Plans: Receive sleep and wake recommendations tailored to each shift, including split-sleep and nap strategies.
- Chronotype Quiz: Discover whether you are a natural early bird or night owl, and get plans adjusted to your biology.
- Meal Timing Guidance: Know when to eat and when to stop eating to support your circadian rhythm on any shift pattern.
- Caffeine Cutoff Alerts: Get a precise caffeine cutoff time before each sleep window so caffeine never sabotages your rest.
- Calendar Export: Export your full sleep plan to Apple Calendar, Google Calendar, or any app that supports ICS files.
- Dark Mode by Default: Designed for people who use their phone in dark environments. Easy on the eyes at 3am.
- Works Offline: Your data stays on your device. No account required, no cloud sync, no tracking.
...
- Security personnel
- Anyone working rotating, irregular, or overnight shifts
...
Your shift schedule and sleep data never leave your device. There is no account to create, no email to enter, and no data sold to third parties. Period.
...
## What's New (v1.0)
Initial release -- import your shifts, get personalized sleep plans, export to your calendar.
